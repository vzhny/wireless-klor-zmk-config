 ...
 * Size: 16 px
 * Bpp: 1
 * Opts: --size 16 --bpp 1 --format lvgl --no-compress --font PixelOperatorMono.ttf -r 0x20-0x7F --lv-font-name pixel_operator_mono -o config/widgets/fonts/pixel_operator_mono.c
 ******************************************************************************/
